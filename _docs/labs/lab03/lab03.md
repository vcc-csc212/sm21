...
1. Download the files below
    ...
    [Cat.h](/sm21/lab03/template-code/Cat.h)
    ...
    [main.cpp](/sm21/lab03/template-code/main.cpp)
    : Contains some preliminary code so you can see how Dog and Cat work.

    [test.cpp](/sm21/lab03/template-code/test.cpp)
    ...
    [doctest.h](/sm21/lab03/template-code/doctest.h)
    ...
    [makefile](/sm21/lab03/template-code/makefile)
